    ...
    <ScrollView contentContainerStyle={{}}>
      ...
      <View style={[styles.parcelContainer]}>
        <View style={[styles.safetyImgContainer]}>
          <Image
            style={[styles.safetyImg, { width: "80%", margin: "auto" }]}
            resizeMode="contain"
            source={require("../../../assets/images/safetylock.png")}
          />
        </View>
      </View>
      ...
      <View style={[styles.menuContainer]}>
        ...
        <MenuHead
          ...
          title="Ride Settings"
          text="Manage Your Ride Prefrences"
        />
...
function MenuItem({ text, onClick }) {
  return (
    <View style={[styles.menuItem, styles.fontsemibold]}>
      <Text>{text}</Text>
